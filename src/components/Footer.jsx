...
const quickLinks2 = [
  { path: "/", display: "Kackanattu Building, Mathumoola, Changanacherry, Kottayam, Kerala, India" },
  { path: "/", display: "+91 790 222 2947" },
  { path: "/", display: "+91 790 222 2878" },
  { path: "/", display: "elsolpowersolutions@gmail.com" },
];
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row md:justify-between gap-6">
          ...
          <div className="flex flex-col gap-6 md:w-1/4">
            <img className="w-[150px] md:w-[200px]" src='' alt="Logo" />
